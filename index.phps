...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
	...
	<?php
    		$glFile="Green_Glass_Study_Lamp_Standalone_Opt.glb";
...
<body>
	...
	<div class="col-12 col-md-7 col-lg-9">
		...
		<script type="module">
			...
			let HDRpath = '../../../hdri/wooden_lounge_0.5k.hdr';
			let backgroundPath = '../../../hdri/wooden_lounge_1k.jpg';
	...
	<div class="col">
		...
		<div class="EnvironmentImage mt-2">
			...
			<select id="hdris" class="content-text">
				...
				<option value="../../../hdri/lebombo_1k.hdr;../../../hdri/lebombo_1k.jpg">
					Lebombo
				</option>
		...
		<div class="row">
			<div class="col-3">
				<div class="intensity intensity_name" style="font-weight: normal; ">Intensity</div>
			</div>
			<div class="col pt-2">
				<input type="range" min="0" max="41" value="19" step="4" class="slider" id="intensityrange">
			</div>
		</div>
		<div class="row">
			<div class="col-3">
